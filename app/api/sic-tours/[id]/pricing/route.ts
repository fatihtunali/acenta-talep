...
// POST - Add pricing period to SIC tour
export async function POST(
  ...
  try {
    ...
    const [result] = await pool.execute<ResultSetHeader>(
      `INSERT INTO sic_tour_pricing (tour_id, start_date, end_date, pp_dbl_rate, single_supplement, child_0to2, child_3to5, child_6to11)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,
      [
        tourId,
        data.startDate || null,
